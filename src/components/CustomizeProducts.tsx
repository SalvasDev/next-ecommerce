...
const CustomizeProducts = () => {
  return (
    <div className='flex flex-col gap-6'> 
        <h4 className='font-medium'>Choos a color</h4>
        ...
        <ul className='flex items-center gap-3'>
          ...
          <li className='ring-1 ring-pink-200 text-white bg-pink-200 marker:rounded-md py-1 px-4 text-sm cursor-not-allowed'>
              Large
          </li>
        </ul>
    </div>

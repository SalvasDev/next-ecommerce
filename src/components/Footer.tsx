     ...
     {/* Top */}
      <div className="flex flex-col md:flex-row justify-between gap-24">
        ...
        <div className="w-full md:w-1/2 lg:w-1/4 flex flex-col gap-8">
          ...
          <p>3252 Widding Way, Central Plaza, Willobrook, CA 90210, United States</p>
          <span className="font-semibold">hello@lama.dev</span>
          <span className="font-semibold">1 234 567 891</span>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-8 mt-16">
        ...
        <div className="flex flex-col gap-8 md:flex-row">
          <div className="">
            <span className="text-gray-500 mr-4">Languaged</span>
            <span className="font-mediun">United States | Ebglish</span>
          </div>
          <div className="">
            <span className="text-gray-500 mr-4">Currency</span>
            <span className="font-mediun">$ USD</span>
          </div>
      </div>
    </div>
  </div>
